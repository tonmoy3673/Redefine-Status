    ...
    return (
        <div className='py-8'>
            ...
            <div className="text-center">
                <div className="">
                    <h1 className="text-3xl font-bold mb-5">We have a coordination test for humanity</h1>
                    ...
                    <div className='py-6'>
                        ...
                        <p className='flex items-center gap-2 mb-3'>
                            <ImPointRight /> <span>Schedule a call <a href='https://www.calendar.com/not-found/' target='blank' className='underline hover:underline-offset-4'>
                            HERE</a></span>
                        </p>
                    </div>
